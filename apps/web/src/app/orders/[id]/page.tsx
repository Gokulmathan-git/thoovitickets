                ...
                {tickets.map((ticket) => (
                  <div
                    ...
                    className={cn(
                      ...
                      ticket.status === 'USED' ? 'border-green-200 bg-green-50' :
                      ticket.status === 'CANCELLED' ? 'border-red-200 bg-red-50 opacity-60' :
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-0.5 text-xs text-gray-500">{ticket.orderItem.ticketType.name}</p>
                      ...
                      {ticket.status === 'CANCELLED' && (
                        <span className="mt-2 inline-flex items-center gap-1 rounded-full bg-red-100 px-2 py-0.5 text-xs font-medium text-red-700">
