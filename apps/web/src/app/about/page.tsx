    ...
    <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Every payment is encrypted and verified. No fraud, no fake tickets.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <Zap className="h-6 w-6 text-orange-500 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-gray-900">Instant Digital Tickets</p>
                  <p className="text-sm text-gray-500">Get your tickets instantly after payment. No waiting, no printouts needed.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <Users className="h-6 w-6 text-orange-500 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-gray-900">Organiser Tools</p>
                  <p className="text-sm text-gray-500">Powerful dashboard with analytics, ticket management, and real-time sales tracking.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <Globe className="h-6 w-6 text-orange-500 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-gray-900">Wide Reach</p>
                  <p className="text-sm text-gray-500">List your events and reach thousands of potential attendees across the platform.</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className="bg-orange-50 py-16">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <h2 className="text-2xl font-bold text-gray-900">Are You an Event Organiser?</h2>
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <a href="/pricing" className="inline-flex h-11 items-center rounded-md border border-gray-300 bg-white px-6 text-sm font-medium text-gray-700 hover:bg-gray-50">
              View Pricing
            </a>
          </div>
        </div>
