        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl rounded-2xl bg-white dark:bg-gray-800 shadow-2xl">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 dark:border-gray-700 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100"
                  />
                </div>
                <Button type="button" size="sm" className="bg-linear-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700" onClick={() => searchLocation(searchQuery)} disabled={searching}>
                  {searching ? '...' : 'Search'}
                </Button>
              </div>
                ...
                <div className="mt-2 max-h-40 overflow-y-auto rounded-lg border border-gray-200">
                  {searchResults.map((result, i) => (
                    <button
                      ...
                      className="flex w-full items-start gap-2 border-b border-gray-100 p-3 text-left text-sm hover:bg-gray-50 dark:bg-gray-900 last:border-0"
                    >
            ...
            <div className="relative h-80">
              ...
              />
              <div className="absolute bottom-3 left-3 rounded-lg bg-white dark:bg-gray-800/90 px-3 py-1.5 text-xs font-medium text-gray-700 backdrop-blur-sm shadow">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-4">
              <div className="mb-3 grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 text-sm outline-none focus:border-orange-400"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="button" className="bg-linear-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700" onClick={confirmLocation}>
                  Confirm Location
                </Button>
              </div>
            </div>
